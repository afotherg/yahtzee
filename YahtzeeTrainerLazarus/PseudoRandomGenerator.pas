...
procedure sgenrand (seed: Cardinal);
function  genrand1_6: integer;
function  genrand_mod (m: Cardinal): Cardinal;
procedure InitRandom (seed: Cardinal);
...
Type
  tMT19937StateArray = array [0..MT19937N-1] of Cardinal {longint};
...
procedure sgenrand{_MT19937}(seed: Cardinal {longint});
var
  i: integer;
begin
...
procedure lsgenrand{_MT19937}(const seed_array: tMT19937StateArray);
VAR
  i: integer;
begin
...
function genrand{_MT19937}: Cardinal {longint};
const
  mag01 : array [0..1] of Cardinal {longint} =(0, MT19937MATRIX_A);
var
  y: Cardinal {longint};
  kk: integer;
begin
  ...
  then begin
     if mti = (MT19937N+1) then  // if sgenrand_MT19937() has not been called,
       sgenrand{_MT19937}(4357);   // default initial seed is used
...
begin
  ...
  sgenrand{_MT19937}(System.randSeed);  // initialize generator state array
